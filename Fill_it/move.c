...
/*   Updated: 2019/06/19 19:52:34 by lminta           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		dl_tetr(t_map_fill *map, t_tetr *last, int i_s, int j_s)
{
	t_minmax	mm;
	int			i;
	int			j;
...
static int		test_pl_tetr(t_map_fill *map, t_tetr *last, int i_s, int j_s)
{
	t_minmax	mm;
	int			i;
	int			j;
...
static int		pl_tetr(t_map_fill *map, t_tetr *last, int i_s, int j_s)
{
	t_minmax	mm;
	int			i;
	int			j;
